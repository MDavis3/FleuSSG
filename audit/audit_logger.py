...
class AuditCountSummary(TypedDict):
    """Aggregated audit logger statistics."""
...
class AuditEventContext:
    """Optional context attached to an audit event."""
    channel_id: int | None = None
    batch_id: int | None = None
    metadata: AuditMetadata = field(default_factory=dict)
...
class AuditLogger:
    ...
    def log(
        ...
        Args:
            ...
            context: Optional event context payload
        ...
        event_context = context or AuditEventContext()
        ...
        event = AuditEvent(
            ...
            batch_id=event_context.batch_id,
            metadata=dict(event_context.metadata),
        )
    ...
    def get_counts(self) -> AuditCountSummary:
